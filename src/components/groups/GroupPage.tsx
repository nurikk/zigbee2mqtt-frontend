...
export type GroupPageProps = WithDevices & WithDeviceStates & WithBridgeInfo & WithGroups
    & StateApi & GroupsApi & SceneApi & RouteComponentProps<UrlParams>;
...
const ConnectedGroupPage = connect<unknown, unknown, PropsFromStore, GroupsApi>(mappedProps, actions)(GroupPageWithRouter);

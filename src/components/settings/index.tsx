    ...
    render() {
        return (
            <div className="card">
                <div className="card-header">
                    <ul className="nav nav-tabs card-header-tabs">
                        <li className="nav-item">
                            <NavLink className="nav-link" activeClassName="active" to={`/settings/settings`}>
                                Settings
                            </NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" activeClassName="active" to={`/settings/bridge`}>
                                Bridge
                            </NavLink>
                        </li>
                    </ul>
                ...
                <div className="card-body">{this.renderSwitcher()}</div>
            </div>
        );
    }
    renderSwitcher() {
                            ...
                            <div key={setting.key} className="row">
                                <div className="col">
                                    ...
                                    <UniversalEditor
                                        ...
                                        value={
                                            get(bridgeInfo.config, setting.path) as
                                                | string

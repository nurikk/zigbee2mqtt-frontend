                ...
                <div className="container">
                    ...
                    <ol>
                        ...
                        <li className="fs-1 lh-lg">
                            <a className="link-primary animation-blinking" href="#" onClick={this.downloadState}>
                        ...
                        <li className="fs-1 lh-lg">
                            In the github issue write detailed description for the issue, how this happened? Steps to
                            reproduce
                        </li>
                    </ol>
                    <div>

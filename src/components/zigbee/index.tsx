...
export class ZigbeeTable extends Component<GlobalState, ZigbeeTableState> {
    ...
    renderDevicesTable() {
        ...
        const lastSeenIsAvaliable =
            bridgeInfo?.config?.advanced?.elapsed || bridgeInfo?.config?.advanced?.last_seen != 'disable';
            ...
            <table className={cx('table table-striped table-borderless align-middle', style.adaptive)}>
                <thead>
                    <tr className="text-nowrap">
                        ...
                        <th>Pic</th>
                        <ActionTH<SortColumn>
                            className={style['action-column']}
                            column="device.friendly_name"
                        ...
                        <ActionTH<SortColumn>
                            className={cx(style['action-column'])}
                            column="device.ieee_address"
                            currentDirection={sortDirection}
                            current={sortColumn}
                            onClick={onSortChange}
                        >
                        ...
                        <ActionTH<SortColumn>
                            className={cx(style['action-column'])}
                            column="device.definition.vendor"
                            currentDirection={sortDirection}
                            current={sortColumn}
                            onClick={onSortChange}
                            titile="definition.vendor"
                        >
                            Manufacturer
                        </ActionTH>
                        <ActionTH<SortColumn>
                            className={style['action-column']}
                            column="device.definition.model"
                            currentDirection={sortDirection}
                            current={sortColumn}
                            onClick={onSortChange}
                        >
                        ...
                        {lastSeenIsAvaliable && (
                            <ActionTH<SortColumn>
                                className={style['action-column']}
                                column={['state.last_seen', 'state.elapsed']}
                                currentDirection={sortDirection}
                                current={sortColumn}
                                onClick={onSortChange}
                            >
                ...
                <tbody>
                    {sortedTableData.map(({ device, state }, id) => (
                        ...
                        >
                            ...
                            <td className={cx('text-truncate', 'text-nowrap', 'position-relative')}>
                                {device.definition?.vendor ?? 'Unsupported'}
                            </td>
